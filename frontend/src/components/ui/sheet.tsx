...
/**
 * A Sheet is a side-anchored Dialog variant — built on `@radix-ui/react-dialog` (same primitive
 * as `dialog.tsx`), NOT `drawer.tsx` (vaul-based bottom-sheet, kept as-is for mobile nav).
 */
...
const sheetVariants = cva(
  'fixed z-50 gap-4 border bg-background p-6 shadow-lg duration-200 data-[state=open]:animate-slide-up',
  {
    variants: {
      side: {
